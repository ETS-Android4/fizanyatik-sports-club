...
public class ViewProfileActivity extends BottomSheetDialogFragment {
    ...
    public static com.sportsclub.fizanyatik.ViewProfileActivity newInstance(String uid, Context context) {

        Bundle args = new Bundle();
        args.putString("uid",uid);
        mContext = context;
        com.sportsclub.fizanyatik.ViewProfileActivity fragment = new com.sportsclub.fizanyatik.ViewProfileActivity();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(getArguments()!=null){
            ...
            reference = FirebaseDatabase.getInstance().getReference("Fusers").child(uid);
            reference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if (user.getImageURL().equals("default")){
                        profile_img.setImageResource(R.drawable.picsign);
                    } else {
                        //change this
